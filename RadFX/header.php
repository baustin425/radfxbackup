                ...
                <div class="u-container-layout u-container-layout-1">
                    <?php
                        if(isset($_SESSION["loggedin"])) {
                            echo "<a class='u-login u-login-1' href='include/logout.inc.php' title='Login'>Log Out</a>";
                        } else {
                            ...
                            echo "<a class='u-login u-login-1' href='login.php' title='Login'>Login</a>";
                        }
                    ?>
                </div>
              </div>
                            ...
                            <?php
                                if(isset($_SESSION["loggedin"])) {
                                  ...
                                  if(isset($_SESSION["role"])) {
                                    ...
                                    echo "</li><li class='u-nav-item'><a class='u-button-style u-nav-link' href='Request.php' style='padding: 28px 16px;'>Request22</a>";
